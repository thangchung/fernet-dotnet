...
namespace Fernet.Internal
{
    ...
    public static class Guard
    {
        ...
        public static class Argument
        {
            ...
            {
                if (value == null) throw new ArgumentNullException(paramName, "String value cannot be null");

                if (string.IsNullOrEmpty(value)) throw new ArgumentException("String value cannot be empty", paramName);
            }
        }
    }
}
